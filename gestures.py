...
class Gestures():
    ...
    @on_main_thread
    def add_long_press(self, view, action, number_of_taps_required=None, number_of_touches_required=None,
                       minimum_press_duration=None, allowable_movement=None):
...
if __name__ == "__main__":
    ...
    class EventDisplay(ui.View):
        ...
        def general_handler(self, data):
            self.t('General: ' + str(data.location) + ' - state: ' + str(data.state) + ' - touches: ' + str(
